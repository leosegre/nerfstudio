...
def main(data_dir, outputs_dir, scene_names, exp_types, downscale, timestamp=None, repeat_reg=10):
    ...
    for exp in exps:
        ...
        total_stats[exp["experiment_name"] + "_no_init"] = {"best": best_exp_stats, "stats_list": stats_list}
    ...
    for exp in exps:
        ...
        total_stats[exp["experiment_name"] + "_single_image"] = {"best": best_exp_stats, "stats_list": stats_list}
    ...
    for exp in exps:
        ...
        total_stats[exp["experiment_name"] + "_no_masks"] = {"best": best_exp_stats, "stats_list": stats_list}
    ...
    if not os.path.exists(base_dir):
        os.mkdir(base_dir)
    total_stats_path = base_dir + curr_timestamp + str(random.randint(0, 100)) + "_ablation.json"
