...
from nerfstudio.models.semantic_nerfacto import SemanticNerfModelConfig
...
descriptions = {
    ...
    "semantic-nerfacto": "Nerfacto with semantic supervision.",
...
method_configs["semantic-nerfacto"] = TrainerConfig(
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=SemanticNerfModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
            "optimizer": AdamOptimizerConfig(lr=1e-2, eps=1e-15),
